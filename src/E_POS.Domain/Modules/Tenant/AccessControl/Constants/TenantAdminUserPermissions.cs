...
public static class TenantAdminUserPermissions
{
    public const string View = "tenant.users.view";
    public const string Create = "tenant.users.create";
    public const string Invite = "tenant.users.invite";
    ...
    public const string RolesView = "tenant.roles.view";
    public const string RolesCreate = "tenant.roles.create";
    public const string RolesUpdate = "tenant.roles.update";
    public const string RolesDelete = "tenant.roles.delete";
    public const string RolesPermissionsView = "tenant.roles.permissions.view";
