...
public sealed class SalesOrderLineComponentConfiguration : IEntityTypeConfiguration<SalesOrderLineComponent>
{
    public void Configure(EntityTypeBuilder<SalesOrderLineComponent> builder)
    {
        ...
        builder.ToTable(t => t.HasCheckConstraint("ck_sales_order_line_components_quantity", "quantity > 0")); 

        builder.ToTable(t => t.HasCheckConstraint("ck_sales_order_line_components_sort_order", "sort_order >= 0")); 
    }
}
