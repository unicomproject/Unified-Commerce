...
[Migration("20260906120000_ReconcileAllPosPermissionsForDevelopmentCashier001")]
public partial class ReconcileAllPosPermissionsForDevelopmentCashier001 : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql("""
            INSERT INTO tenant_user_permissions (
                ...
                created_at)
            SELECT
                md5('development-cashier001-pos-reconciliation:' || permission_definitions.permission_code)::uuid,
            ...
            WHERE upper(tenant_users.email) = 'CASHIER001@GMAIL.COM'
              ...
              AND (
                  permission_definitions.permission_code LIKE 'pos.%'
                  OR permission_definitions.permission_code = 'commerce.online_order.orders.access')
