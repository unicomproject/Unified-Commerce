...
namespace E_POS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260703221344_AlignModules24To28WithSecondBrain")]
    partial class AlignModules24To28WithSecondBrain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Notification.Entities.NotificationEvent", b =>
                {
                    ...
                    b.ToTable("notification_events", null, t =>
                        {
                            t.HasCheckConstraint("ck_notification_events_priority", "priority IN ('LOW', 'NORMAL', 'HIGH', 'URGENT')");
                        });
                });
                    ...
                    b.ToTable("notification_inbox_items", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_notification_inbox_items_recipient_type_platform_user_id_tenant_user_id", "(recipient_type = 'PLATFORM_USER' AND platform_user_id IS NOT NULL) OR (recipient_type = 'TENANT_USER' AND tenant_user_id IS NOT NULL) OR (recipient_type = 'CUSTOMER' AND customer_id IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Notification.Entities.NotificationReadReceipt", b =>
                {
                    ...
                    b.ToTable("notification_read_receipts", null, t =>
                        {
                            t.HasCheckConstraint("ck_notification_read_receipts_recipient_type_platform_user_id_tenant_user_id", "(recipient_type = 'PLATFORM_USER' AND platform_user_id IS NOT NULL) OR (recipient_type = 'TENANT_USER' AND tenant_user_id IS NOT NULL) OR (recipient_type = 'CUSTOMER' AND customer_id IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Notification.Entities.NotificationTemplate", b =>
                {
                    ...
                    b.HasIndex("TenantId", "TemplateCode")
                        .IsUnique()
                        .HasDatabaseName("uq_notification_templates_tenant_id_template_code");
                    ...
                    b.ToTable("payment_methods", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_payment_methods_sort_order", "sort_order >= 0");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Payment.Entities.SalesPayment", b =>
                {
                    ...
                    b.HasIndex("TenantId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("uq_sales_payments_tenant_id_idempotency_key")
                        .HasFilter("idempotency_key IS NOT NULL");
                    ...
                    b.ToTable("sales_payments", null, t =>
                        {
                            t.HasCheckConstraint("ck_sales_payments_change_amount", "change_amount >= 0");

                            t.HasCheckConstraint("ck_sales_payments_paid_amount", "paid_amount >= 0");

                            t.HasCheckConstraint("ck_sales_payments_refunded_amount", "refunded_amount <= paid_amount");

                            t.HasCheckConstraint("ck_sales_payments_requested_amount", "requested_amount IS NULL OR requested_amount > 0");

                            t.HasCheckConstraint("ck_sales_payments_tendered_amount", "tendered_amount IS NULL OR tendered_amount >= 0");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Payment.Entities.SalesPaymentTransaction", b =>
                {
                    ...
                    b.HasIndex("TenantId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("uq_sales_payment_transactions_tenant_id_idempotency_key")
                        .HasFilter("idempotency_key IS NOT NULL");

                    b.HasIndex("TenantId", "ProviderName", "ExternalTransactionReference")
                        .IsUnique()
                        .HasDatabaseName("uq_sales_payment_transactions_provider_ext_ref")
                        .HasFilter("provider_name IS NOT NULL AND external_transaction_reference IS NOT NULL");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Refund.Entities.SalesRefund", b =>
                {
                    ...
                    b.ToTable("sales_refunds", null, t =>
                        {
                            t.HasCheckConstraint("ck_sales_refunds_approved_amount", "approved_amount <= requested_amount");

                            t.HasCheckConstraint("ck_sales_refunds_refunded_amount", "refunded_amount <= approved_amount");
                    ...
                    b.ToTable("sales_refund_lines", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_sales_refund_lines_quantity", "quantity IS NULL OR quantity > 0");
                        });
                });
                    ...
                    b.ToTable("sales_refund_payment_allocations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_sales_refund_payment_allocations_allocation_status", "allocation_status IN ('PENDING', 'SUCCESS', 'FAILED')");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.ReturnExchange.Entities.ReturnInspection", b =>
                {
                    ...
                    b.ToTable("return_inspections", null, t =>
                        {
                            t.HasCheckConstraint("ck_return_inspections_reject_quantity", "reject_quantity IS NULL OR reject_quantity >= 0");

                            t.HasCheckConstraint("ck_return_inspections_restock_quantity", "restock_quantity IS NULL OR restock_quantity >= 0");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.ReturnExchange.Entities.SalesExchange", b =>
                {
                    ...
                    b.ToTable("sales_exchanges", null, t =>
                        {
                            t.HasCheckConstraint("ck_sales_exchanges_additional_payment_amount", "additional_payment_amount >= 0");

                            t.HasCheckConstraint("ck_sales_exchanges_price_difference_amount", "price_difference_amount >= 0");

                            t.HasCheckConstraint("ck_sales_exchanges_refund_back_amount", "refund_back_amount >= 0");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.ReturnExchange.Entities.SalesExchangeLine", b =>
                {
                    ...
                    b.ToTable("sales_exchange_lines", null, t =>
                        {
                            t.HasCheckConstraint("ck_sales_exchange_lines_quantity", "quantity > 0");
                        });
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Integration.Entities.PlatformIntegration", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.PlatformAdministration.Entities.PlatformUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_platform_integrations_created_by_platform_user_id_platform_users");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Integration.Entities.PlatformIntegrationCredential", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.PlatformAdministration.Entities.PlatformUser", null)
                        ...
                        .HasForeignKey("CreatedByPlatformUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_platform_integration_credentials_created_by_platform_user_id_platform_users");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Notification.Entities.NotificationPreference", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.Customer.Entities.Customer", null)
                        ...
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_notification_preferences_customer_id_customers");
                    ...
                    b.HasOne("E_POS.Domain.Modules.PlatformAdministration.Entities.PlatformUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_notification_preferences_platform_user_id_platform_users");

                    b.HasOne("E_POS.Domain.Modules.AccessControl.Entities.TenantUser", null)
                        .WithMany()
                        .HasForeignKey("TenantUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_notification_preferences_tenant_user_id_tenant_users");
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Notification.Entities.NotificationReadReceipt", b =>
                {
                    ...
                    b.HasOne("E_POS.Domain.Modules.Notification.Entities.NotificationMessage", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_notification_read_receipts_notification_message_id_notification_messages");
                });
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.OfflineSync.Entities.SyncConflict", b =>
                {
                    ...
                    b.HasOne("E_POS.Domain.Modules.AccessControl.Entities.TenantUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sync_conflicts_resolved_by_tenant_user_id_tenant_users");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Payment.Entities.SalesPaymentTransaction", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.Payment.Entities.SalesPaymentTransaction", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sales_payment_transactions_parent_transaction_id_sales_payment_transactions");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.Refund.Entities.SalesRefundPaymentAllocation", b =>
                {
                    ...
                    b.HasOne("E_POS.Domain.Modules.Payment.Entities.PaymentMethod", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_sales_refund_payment_allocations_refund_payment_method_id_payment_methods");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.ReturnExchange.Entities.SalesExchange", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.Orders.Entities.SalesOrder", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sales_exchanges_replacement_sales_order_id_sales_orders");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.ReturnExchange.Entities.SalesReturn", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.ReturnExchange.Entities.ReturnReason", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sales_returns_return_reason_id_return_reasons");
            ...
            modelBuilder.Entity("E_POS.Domain.Modules.ReturnExchange.Entities.SalesReturnLine", b =>
                {
                    b.HasOne("E_POS.Domain.Modules.ReturnExchange.Entities.ReturnReason", null)
                        ...
                        .HasForeignKey("ReturnReasonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sales_return_lines_return_reason_id_return_reasons");
