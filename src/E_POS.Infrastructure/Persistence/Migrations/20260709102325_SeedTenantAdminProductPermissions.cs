...
{
    /// <inheritdoc />
    public partial class SeedTenantAdminProductPermissions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                FROM (
                    VALUES
                        ('77777777-0050-4000-8000-000000000001'::uuid, 'tenant.products.view', 'view', 'View tenant products')
                ...
                SELECT
                    ...
                    'Tenant admin product management permission seed.',
                    now()
                FROM (
                    VALUES
                        ('TENANT_ADMIN', 'tenant.products.view'),
                        ('STORE_MANAGER', 'tenant.products.view'),
                        ('INVENTORY_MANAGER', 'tenant.products.view')
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                WHERE tenant_role_permissions.permission_id = permission_definitions.id
                  AND permission_definitions.permission_code = 'tenant.products.view';

                DELETE FROM permission_definitions
                WHERE permission_code = 'tenant.products.view';
                """);
        }
    }
}
