...
namespace E_POS.Infrastructure.Persistence.Migrations
{
    ...
    public partial class SeedDevelopmentStorefrontData : Migration
    {
        ...
        VALUES
            ...
            ('dddd0002-0003-4000-8000-000000000001', '55555555-0000-4000-8000-000000000001', 'cccc0004-0008-4000-8000-000000000001', 'shoe-1', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=1000&auto=format&fit=crop', 'DEFAULT', 0, true, 'ACTIVE', now(), now()),
            ('dddd0002-0004-4000-8000-000000000001', '55555555-0000-4000-8000-000000000001', 'cccc0004-0009-4000-8000-000000000001', 'shoe-2', 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?q=80&w=1000&auto=format&fit=crop', 'DEFAULT', 0, true, 'ACTIVE', now(), now()),
            ('dddd0002-0005-4000-8000-000000000001', '55555555-0000-4000-8000-000000000001', 'cccc0004-000a-4000-8000-000000000001', 'cap-1', 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?q=80&w=1000&auto=format&fit=crop', 'DEFAULT', 0, true, 'ACTIVE', now(), now()),
