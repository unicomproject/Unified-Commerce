...
public static class PlatformAdminPermissionsSeedData
{
    ...
    [
        ...
        new(Guid.Parse("62000000-0000-0000-0000-000000000038"), PlatformPermissionCodes.TenantsBootstrapAccess, "Selected Tenant Bootstrap Access", "Enter Selected-Tenant mode and view the setup hub."),
        new(Guid.Parse("62000000-0000-0000-0000-000000000039"), PlatformPermissionCodes.TenantsBootstrapOutletsManage, "Bootstrap Outlets", "Create bootstrap outlets for a selected tenant."),
        new(Guid.Parse("62000000-0000-0000-0000-000000000040"), PlatformPermissionCodes.TenantsBootstrapTillsManage, "Bootstrap Tills", "Create bootstrap tills for a selected tenant."),
        new(Guid.Parse("62000000-0000-0000-0000-000000000041"), PlatformPermissionCodes.TenantsBootstrapRolesManage, "Bootstrap Roles", "Create bootstrap tenant roles for a selected tenant."),
