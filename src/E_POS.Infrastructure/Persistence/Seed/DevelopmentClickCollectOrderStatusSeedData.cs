        ...
        seed_orders AS (
            SELECT * FROM (
                VALUES
                    ...
                    (3, 'e0000101-0003-4000-8000-000000000001'::uuid, 'ECOMM-SEED-ACCEPTED-001',  'ACCEPTED',  'ACCEPTED',             'UNPAID', 0.0000, 4200.0000, 4200.0000, 1.0000, 'cccc0004-0005-4000-8000-000000000001'::uuid, 'cccc0005-0005-4000-8000-000000000001'::uuid, 'Running Shoes',     'MER-005-SKU', 0.0000, 'ACTIVE',    interval '46 hours'),
                    (4, 'e0000101-0004-4000-8000-000000000001'::uuid, 'ECOMM-SEED-ACCEPTED-002',  'ACCEPTED',  'ACCEPTED',             'UNPAID', 0.0000, 1800.0000, 1800.0000, 1.0000, 'cccc0004-0007-4000-8000-000000000001'::uuid, 'cccc0005-0007-4000-8000-000000000001'::uuid, 'Team Cap',          'MER-007-SKU', 0.0000, 'ACTIVE',    interval '44 hours'),
                    ...
                    (8, 'e0000101-0008-4000-8000-000000000001'::uuid, 'ECOMM-SEED-READY-002',     'ACCEPTED',  'READY_FOR_COLLECTION', 'UNPAID', 0.0000, 4500.0000, 4500.0000, 1.0000, 'cccc0004-000e-4000-8000-000000000001'::uuid, 'cccc0005-000e-4000-8000-000000000001'::uuid, 'Gym Bag',           'MER-014-SKU', 0.0000, 'ACTIVE',    interval '36 hours'),
        ...
        WITH seed_orders AS (
            SELECT * FROM (
                VALUES
                    ...
                    (3, 'e0000101-0003-4000-8000-000000000001'::uuid, 1.0000, 4200.0000, 0.0000, 'cccc0004-0005-4000-8000-000000000001'::uuid, 'cccc0005-0005-4000-8000-000000000001'::uuid, 'Running Shoes',      'MER-005-SKU',     0.0000, 'ACTIVE'),
                    (4, 'e0000101-0004-4000-8000-000000000001'::uuid, 1.0000, 1800.0000, 0.0000, 'cccc0004-0007-4000-8000-000000000001'::uuid, 'cccc0005-0007-4000-8000-000000000001'::uuid, 'Team Cap',           'MER-007-SKU',     0.0000, 'ACTIVE'),
                    ...
                    (8, 'e0000101-0008-4000-8000-000000000001'::uuid, 1.0000, 4500.0000, 0.0000, 'cccc0004-000e-4000-8000-000000000001'::uuid, 'cccc0005-000e-4000-8000-000000000001'::uuid, 'Gym Bag',            'MER-014-SKU',     0.0000, 'ACTIVE'),
